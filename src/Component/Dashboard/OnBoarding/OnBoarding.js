          ...
          <div className={"reb-card-heading-boding"} onClick={handleToggle}>
            <LegacyStack vertical spacing={"tight"}>
              <LegacyStack alignment={"center"} wrap={false}>
                ...
                <LegacyStack.Item>
                  <div onClick={handleToggle}><Icon source={open ? CaretUpMinor : CaretDownMinor}/></div>
                </LegacyStack.Item>
              </LegacyStack>
            </LegacyStack>
          </div>
          ...
          <div className={"reb-card-section"}>
            {
              (boardingOptions || []).map((x, i) => {
                return (
                  <Fragment key={i}>
                    <div className={"mb-1 cursor-pointer"} onClick={() => setSelectedBoarding(x.selected)}>
                      <div className={"reb-card-analytics"}
                        ...
                        <LegacyStack spacing={"extraTight"} wrap={false}>
                          <LegacyStack.Item>
                            ...
                            {/*  <circle cx="14" cy="14" r="13" stroke="#8A8A8A" stroke-width="2" stroke-linecap="round"*/}
                            {/*          stroke-dasharray="5 5"/>*/}
                            {/*</svg>*/}
                            <div className={`boding-count ${selectedBoarding === x.selected ? "boding-count-active" : ""}`}>{i + 1}</div>
                            &nbsp;
                            &nbsp;
                            &nbsp;
                            &nbsp;
                          ...
                          <LegacyStack.Item fill>
                            {selectedBoarding === x.selected ? <Text variant="headingSm" as="h3">{x.title}</Text> :
                              <Text variant="headingSm" as="h3" fontWeight={"regular"}>{x.title}</Text>}

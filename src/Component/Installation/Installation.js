...
import {Grid, Layout, List, Page, Text, Link, Card, BlockStack, Box, Divider} from '@shopify/polaris'
    ...
    const renderLinkImage = (imageData) => {
        return (
            <Link url={imageData} external>
                <img className='install-img' src={imageData} width="100%" height="100%"/>
            </Link>
        )
    };
    ...
    return (
        <Fragment>
            <Page backAction={{content: 'BAckInStock', onAction: () => navigate(`${baseUrl}/settings`)}}
                ...
                <Layout>
                    <Layout.Section>
                        <Text variant='headingLg' fontWeight={"bold"}>Configure Wishlist Club widget on your
                            theme</Text>
                    </Layout.Section>
                    <Layout.Section>
                        <Card padding={"500"}>
                    ...
                    <Layout.Section>
                        <Card padding={"500"}>
                            <BlockStack gap={"400"}>
                                <Text as={"h2"} variant={"headingMd"}>Please follow the steps to add wishlist icon in
                                    header</Text>
                                <Grid>
                                    <Grid.Cell columnSpan={{xs: 6, sm: 6, md: 6, lg: 6, xl: 6}}>
                                        <BlockStack gap={"400"}>
                            ...
                            <BlockStack>
                                <Box padding={"500"}>
                                    <BlockStack gap={"500"}>
                                        ...
                                        <Grid>
                                            <Grid.Cell columnSpan={{xs: 6, sm: 6, md: 6, lg: 6, xl: 6}}>
                                                <BlockStack gap={"400"}>
                                                    <Text as={"h5"} fontWeight={"bold"}>1. Paste this code to display
                                                        Wishlist
                                                    ...
                                                    <Text as={"span"}>Please add the below code under your add to cart
                                                        button.</Text>
                                                    <CopyCode
                                ...
                                <Box padding={"500"}>
                                    <Grid>
                                        <Grid.Cell columnSpan={{xs: 6, sm: 6, md: 6, lg: 6, xl: 6}}>
                                            <BlockStack gap={"400"}>
                                                <Text as={"h5"} fontWeight={"bold"}>2. Paste this code to display
                                                    Wishlist Button Collection Page </Text>
                                                <Text as={"span"}>Open <Text as={"span"}
                                                ...
                                                <Text as={"span"}>Please add the below code under the product price.</Text>
                                                <CopyCode
                    ...
                    <Layout.Section>
                        <Card padding={"0"}>
                            <BlockStack>
                                <Box padding={"500"}>
                                    <BlockStack gap={"500"}>
                                        <Text as={"h2"} variant={"headingMd"}>B: Back in stock shortcode</Text>
                                        <Grid>
                                            <Grid.Cell columnSpan={{xs: 6, sm: 6, md: 6, lg: 6, xl: 6}}>
                                                <BlockStack gap={"400"}>
                                                    <Text as={"h5"} fontWeight={"bold"}>1.Paste this code to display
                                ...
                                <Box padding={"500"}>
                                    <Grid>
                                        <Grid.Cell columnSpan={{xs: 6, sm: 6, md: 6, lg: 6, xl: 6}}>
                                            <BlockStack gap={"400"}>
                                                <Text as={"h5"} fontWeight={"bold"}>2. Paste this code to display Back
                                                    in

...
const Installation = () => {
    ...
    return (
        <Fragment>
            <Page  backAction={{content: 'BAckInStock', onAction: () => navigate(`${baseUrl}/settings`)}} title={"Installation"}>
                <Layout>
                    <Layout.Section>
                    ...
                    <Layout.Section>
                        <Card padding={"500"}>
                            <BlockStack gap={"400"}>
                            <Text as={"h2"} variant={"headingMd"}>Please follow the steps to add wishlist icon in header</Text>
                            <Grid>
                                <Grid.Cell columnSpan={{xs: 6, sm: 6, md: 6, lg: 6, xl: 6}}>
                                    <BlockStack gap={"400"}>
                                        <List type="number">

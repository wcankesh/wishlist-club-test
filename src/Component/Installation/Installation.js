                                ...
                                <Grid>
                                    <Grid.Cell columnSpan={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
                                        <Text variant='bodyMd'>Please click&nbsp;<Link
                                            url={`https://${shopDetails}/admin/themes/current/editor?context=apps&amp;appEmbed=gid://shopify/OnlineStoreThemeAppEmbed/wishlist-club`}
                                            ...
                                            <BlockStack gap={"400"}>
                                                <List type="number">
                                                    <List.Item> Open your Shopify store Theme <Link
                                                        url={`https://${shopDetails}/admin/themes`} target="_blank"
                                                ...
                                                <BlockStack gap={"400"}>
                                                    ...
                                                    <List type="number" spacing="loose">
                                                        <List.Item> Open your Shopify site's main navigation <a
                                                            href={`https://${shopDetails}/admin/themes`}
                                                            target="_blank"

...
const Email = () => {
    ...
    const Customization_Email = [
        {
            ...
            path: "email-settings/wishlistemail",
        ...
        },
        {
            ...
            path: "email-settings/pricealert",
        ...
        },
        {
            ...
            path: "email-settings/restockalert",
    ...
    const saveEmailSetting = async (record) => {
        ...
        const response = await apiService.updateEmailSetting(payload, emailSetting.id);
                            ...
                            <Layout.AnnotatedSection id="storeDetails" title="Email Customization"
                                ...
                                <LegacyCard>
                                    {(Customization_Email || []).map((x, i) => {
                                        return (
                                            <LegacyCard.Section title={x.title} actions={[{
                                                content: 'Edit',

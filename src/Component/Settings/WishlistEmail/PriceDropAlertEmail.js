...
const PriceDropAlertEmail = () => {
    ...
    const saveEmailSetting = async (record, isLoad) => {
        if (isLoad) {
            ...
            let tempObj = {
                price_drop_email_subject: emailSetting.price_drop_email_subject,
                                                                                                    ...
                                                                                                    <th className="shop-branding"
                                                                                                        style={{ display: "flex", alignItems: "center", justifyContent: "center", color: 'rgb(32, 34, 35)', fontSize: '24px', fontWeight: 'bold', lineHeight: '28px', height: '70px', textAlign: 'center', paddingTop: '20px', }}>
                                                                                                        {
                                                                                                            emailSetting.price_drop_branding_type == "2" ?
                                                                                                                ...
                                                                                                                emailSetting.price_drop_branding_type == "1" ? shopDetails && shopDetails?.shop.store_name :
                                                                                                                    <Fragment>
                                                                                                                        {selectedPriceLogo?.name ? <img src={selectedPriceLogo ? URL.createObjectURL(selectedPriceLogo) : ""} alt="logo" style={{ maxHeight: '50px' }} /> : emailSetting.price_drop_logo ? <img src={emailSetting.price_drop_logo} alt="logo" style={{ maxHeight: '50px' }} /> : <img src={""} alt="logo" style={{ maxHeight: '50px' }} />}&nbsp; {shopDetails && shopDetails?.shop.store_name}
                                                                                                                    </Fragment>
                                                                                                        }
                                                                                                    </th>
                                                                                                </tr>

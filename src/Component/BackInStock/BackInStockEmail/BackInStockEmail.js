...
import {Page, Layout, LegacyCard, Text, Button, LegacyStack} from '@shopify/polaris';
    ...
    return (
        <Fragment>
            <Page title={"Back In Stock Email"} backAction={{content: 'BAckInStock', onAction: onBack}}
                // subtitle={`By enabling the "Back in Stock Notification," you can send alerts to customers who have subscribed using the "Notify me" button for sold-out products. Also, activating the "Thank you Notification" will display a Thank you message to customers after they click the "Notify me" button.`}
            >
                <Layout>

...
import {
    Layout, FormLayout, TextField, Checkbox, Text, Button, Tooltip, BlockStack, Card,
    InlineStack
                ...
                <Card padding={"400"}>
                    <BlockStack gap={"400"}>
                        <InlineStack align={"space-between"}>
                            <Text as={"span"} variant={"headingMd"} fontWeight={"medium"}>Customize Collection Page
                                Button</Text>
                        ...
                        <FormLayout>
                            <FormLayout.Group condensed>
                                <TextField label="Text" value={backInStockDesign.collection_page_widget.text}
                            ...
                            <FormLayout.Group condensed>
                                <ColorInput label={"Background Color"} name="bg_color" onChange={handleChange}
                                ...
                                <TextField label="Border Raduis" type="number" suffix="PX"
                                           ...
                                           onChange={(value) => handleChange({target: {name: "border_radius", value}})
                                           }/>
                            </FormLayout.Group>
                            <FormLayout.Group condensed>
                                ...
                                <TextField label="Border Size" type="number" suffix="PX"
                                           ...
                                           onChange={(value) => handleChange({target: {name: "border_size", value}})
                                           }/>
                            </FormLayout.Group>
                            <FormLayout.Group condensed>
                                <TextField label="Top & Bottom Padding" type="number" suffix="PX"
                                           ...
                                           onChange={(value) => handleChange({
                                               target: {name: "button_top_bottom_padding", value}
                                           })}/>
                            ...
                            <FormLayout.Group>
                                <Checkbox label="Show icon"
                                          checked={backInStockDesign.collection_page_widget.is_icon == "1"}
                                          onChange={(checked) => {
                                              handleChange({target: {name: "is_icon", value: checked ? "1" : "0"}})
                                          }}/>
                            </FormLayout.Group>
                            <FormLayout.Group condensed>
                                <ColorInput label={"Icon Color"} name="icon_color" onChange={handleChange}

...
const SubscriberMsg = (props) => {
    const { backInStockDesign, setBackInStockDesign, setBackInStockDesignError, backInStockDesignError, formValidate } = props
    const handleChange = (e) => {
        ...
        if (backInStockDesignError[name]) { setBackInStockDesignError({ ...backInStockDesignError, [name]: value.trim() ? "" : backInStockDesignError[name] }) }
    }
                    ...
                    <BlockStack gap={"400"}>
                        ...
                        <FormLayout>
                            <FormLayout.Group condensed>
                                <TextField label="Message" multiline={3} name={"success_message"} onBlur={onBlur}
                            ...
                            <FormLayout.Group condensed>
                                <TextField label="Already Subscribed Message" multiline={3} onBlur={onBlur}
                            ...
                            {/* <FormLayout.Group condensed>
                                <TextField label="Notification Message" multiline={4} onBlur={onBlur}   name={"notification_message"} error={backInStockDesignError.notification_message} value={backInStockDesign.subscription_message.notification_message} onChange={(value) => handleChange({ target: { name: "notification_message", value } })} />
                            </FormLayout.Group> */}
                            {/* <FormLayout.Group condensed>
                                <ColorInput label={"Toast Text Color"} name="text_color" onChange={handleChange} value={backInStockDesign.subscription_message.text_color} />
                                <ColorInput label={"Toast Background Color"} name="background_color" onChange={handleChange}value={backInStockDesign.subscription_message.background_color} />
                            </FormLayout.Group> */}
                        </FormLayout>
                    </BlockStack>
                </Card>

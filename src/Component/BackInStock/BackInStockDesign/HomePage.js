...
import {
    Layout, FormLayout, TextField, Checkbox, Text, Button, Tooltip, BlockStack, Card, InlineStack
                ...
                <Card padding={"400"}>
                    <BlockStack gap={"400"}>
                        <InlineStack align={"space-between"}>
                            <Text as={"span"} variant={"headingMd"} fontWeight={"medium"}>Customize Home Page
                                Button</Text>
                        ...
                        <FormLayout>
                            <FormLayout.Group condensed>
                                <TextField label="Text" value={backInStockDesign.home_page_widget.text}
